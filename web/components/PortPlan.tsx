  ...
  return (
    <section className="block" data-reveal style={{ borderBottom: 0 }}>
      ...
      <p style={{ color: "var(--dim)", fontSize: 14, maxWidth: "60ch", marginBottom: 20 }}>
        The changes FoldReady can prove are safe: removing the full-screen opt-out and
        the UIKit sidebar opt-in. Review each diff, download a patch, or apply them
        locally with the CLI. The work that needs judgement ships as a work order for
        Apple&apos;s app modernization agent skill, not as a generated patch.
      </p>
