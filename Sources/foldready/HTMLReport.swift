...
enum HTMLReport {
    ...
    static func render(_ result: AuditResult) -> String {
        ...
        <div class="wrap">
          ...
          <footer>Generated by FoldReady. Every check cites the Apple source it is derived from; the score measures how well the app uses a resizable canvas.</footer>
        </div>
        </body>
        </html>
        """
